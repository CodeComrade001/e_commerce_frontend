...
import EditProductDetails from "../reusable_module/edit_product_details";
...
export default function AllProductComponent(): JSX.Element {
  ...
  const setProductForEdit = useCallback(
    (productId: number) => {
      // find the one product whose id matches
      const selected = products.find(item => item.id === productId) ?? null;
      setProductForEditing(selected);
    },
    [products],  // <-- include products in your deps
  );
  ...
  return (
    <div className="Admin_All_product">
      ...
      <div className="available_items_container">
        ...
        <div className="responsive_side_bar">
              ...
              products.map((item, index) => (
                <div key={item.id} className="product_container">
                  ...
                  <nav>
                    ...
                    <button title="edit"
                      onClick={() => setProductForEdit(item.id)}
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-cart-check-fill" viewBox="0 0 16 16">
                        <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0m7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0m-1.646-7.646-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L8 8.293l2.646-2.647a.5.5 0 0 1 .708.708" />
                      </svg>
          ...
          {productForEditing !== null && (
            <div className="edit_saved_task_container">
              <EditProductDetails
                PreVProductDetails={productForEditing}
              />
            </div>
          )}
        </div>
